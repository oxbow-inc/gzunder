...
TORTOISE_ORM = {
    "connections": {"default": "postgres://postgres:secret@localhost:5432/stage"},
    "apps": {
        "models": {
            "models": ["core.db", "aerich.models"],
...
class Dialog(Model):
    ...
    user_from = fields.ForeignKeyField('models.User', related_name='dialogs_sent')  # user.dialogs
